...
public class AboutPanel extends JPanel {
    ...
    private void loadContent() {
        ...
        aboutSheet.addRule("body { font-family: sans-serif; font-size: 13px; background-color: " + bodyBg + "; color: "
                + bodyFg + "; padding: 24px; line-height: 1.6; }");
        aboutSheet.addRule("h2 { color: " + headerColor + "; border-bottom: 1px solid " + borderColor
                + "; padding-bottom: 6px; font-size: 16px; font-weight: bold; margin-top: 24px; }");
        aboutSheet
                .addRule("h3 { color: " + subHeaderColor + "; font-size: 14px; font-weight: bold; margin-top: 14px; }");
        ...
        aboutPane.setText("<html><body>" +
                ...
                "<h2>Changelog</h2>" +
                "<ul>" +
                "<li><b>v2.3.0 (Current)</b>: Added portable application image, installer EXE, and ZIP package.</li>" +
                "<li><b>v2.2.0</b>: Added dynamic light and dark theme switching with dynamic contrast canvases. Re-engineered progress sidebar to map 4 major workflow steps, fixing index offsets. Shifted visual layout so detailed snapshots appear contextually in the header. Added singular/plural metadata formatting.</li>"
                +
                "<li><b>v2.1.0</b>: Redesigned workflow with a modern centered Home screen, a clean guided step progress stage, an interactive Chain Selection view, and a high-focus Prediction Workspace with a vertical pipeline sidebar and a metadata-driven bottom panel. Replaced massive console output with a collapsible/dialog styled log view.</li>"
                +
                ...
                +
                "<li><b>v1.9.0</b>: Optimized Louvain partition sizing calculations from O(N) to O(1) in Predictor.java. Implemented step-wise chain selection scanner.</li>"
                +
